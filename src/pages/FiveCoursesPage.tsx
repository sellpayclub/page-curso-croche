...
export default function FiveCoursesPage() {
  return (
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 font-serif text-stone-900">
              Quantas vezes você já desistiu de uma peça por não saber como continuar?
            </h2>
            <div className="w-24 h-1 bg-rose-500 mx-auto rounded-full mb-8"></div>
            <p className="text-lg md:text-xl text-stone-600 leading-relaxed">
              Aqui no <span className="font-bold text-rose-600">Curso Belle Crochê</span>, você tem acesso a aulas completas de crochê, 100% passo a passo — cobrindo bolsas, roupas infantis, peças de casa, vestidos e muito mais.
            </p>
            <p className="text-lg md:text-xl text-stone-600 leading-relaxed mt-4">
              Se você já sabe crochê e quer aprender novos modelos com explicação clara, detalhada e sem enrolação, aqui você encontra exatamente isso.
            </p>
            <p className="text-lg md:text-xl text-stone-600 leading-relaxed mt-4">
              As aulas mostram cada etapa da construção das peças, do início ao acabamento, para você acompanhar com segurança e precisão. É conteúdo direto ao ponto, focado em ensinar modelos variados de forma prática e organizada.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border-t-4 border-rose-500">
              ...
              <p className="text-stone-600">Aprenda a finalizar peças com perfeição, acertar medidas e alcançar um acabamento bonito e profissional.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border-t-4 border-rose-500">
      ...
      <section className="py-16 md:py-24 bg-stone-900 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-stone-400 mb-12 text-sm">
            Aviso: Esses valores não são promessas. São exemplos do que alunas conseguem vendendo peças sob encomenda.
          </p>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border-2 border-rose-500 relative order-1 md:order-2 transform md:-translate-y-4">
              ...
              <div className="mb-6">
                <img 
                  src="https://xyzgvsuttwrvbyyxdppq.supabase.co/storage/v1/object/public/videos%20croche/mockup%20cursos.png" 
                  alt="Mockup do curso" 
                  className="w-full h-auto rounded-lg shadow-sm mb-4"
                />
                <p className="font-bold text-stone-800 mb-2">O curso inclui:</p>
                <ul className="space-y-2 text-sm text-stone-600 mb-4">
                  <li className="flex items-center gap-2"><Check size={14} className="text-rose-500"/> Curso de Bolsas Crochê</li>
                  <li className="flex items-center gap-2"><Check size={14} className="text-rose-500"/> Curso de Roupas Infantil de Crochê</li>
                  <li className="flex items-center gap-2"><Check size={14} className="text-rose-500"/> Curso de Peças de Casa de Crochê</li>
                  <li className="flex items-center gap-2"><Check size={14} className="text-rose-500"/> Curso de Vestidos em Crochê</li>
                  <li className="flex items-center gap-2"><Check size={14} className="text-rose-500"/> Curso de Marketing e Vendas</li>
                </ul>
              </div>
              ...
              <a 
                href="https://seguro.vitago-suplements.shop/r/S760HB8BUU"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-200">
              ...
              <p className="text-stone-600 leading-relaxed text-lg">Não. Além da base, você aprende construção de peças variadas, ajuste de medidas, acabamento profissional e organização de receita. É exatamente o que falta para quem já faz crochê, mas ainda não consegue entregar peças com padrão de venda.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-200">
              <h3 className="font-sans font-bold text-xl mb-3 text-stone-900">3. Quanto tempo leva para fazer uma peça?</h3>
              <p className="text-stone-600 leading-relaxed text-lg">Depende do modelo e da sua prática. Iniciantes podem levar alguns dias na primeira peça. Com prática, é possível produzir de 2 a 4 peças por semana. Se você não tem tempo nem para produzir algumas horas por semana, então renda extra com crochê não é para você.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-200">
              ...
              <p className="text-stone-600 leading-relaxed text-lg">É possível, mas não automático. Os cálculos da página mostram uma conta simples: se você lucra em média R$ 85 por peça, precisa produzir e vender cerca de 35 a 60 peças no mês. Isso exige produção, divulgação e consistência. Não é promessa de dinheiro fácil.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-200">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-200">
              ...
              <p className="text-stone-600 leading-relaxed text-lg">Não. As peças são feitas totalmente em crochê. Você precisa apenas de: agulha, linha, tesoura e fita métrica.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-200">
      ...
      <footer className="bg-white border-t border-stone-200 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="mt-8 pt-8 border-t border-stone-100 text-stone-400 text-xs">
            &copy; 2026 Belle Crochê. Todos os direitos reservados.
          </div>
        </div>
      </footer>
    </div>
